...
// TODO Turn this into UI callback
...
// TODO Remove this; keep for now for reference
...
// TODO Convert the command line arguments into method parameters
- (int)runBasicExample
{
    xmpp_ctx_t *ctx;
    xmpp_conn_t *conn;
    xmpp_log_t *log;
    // TODO Hard code the parameters for testing
